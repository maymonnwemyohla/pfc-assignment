...
git push origin cs-ep-06
```

**Final Step:** Go to your forked repository on GitHub, switch to the `cs-ep-06` branch, and click **"Compare & pull request"** to submit your assignment to the main repository for review.
